...
const THEMES_BY_LEVEL = {
  ...
  '4': ['animals', 'food', 'colors', 'body', 'family', 'numbers', 'days', 'clothes', 'transport'],
  '5': ['animals', 'food', 'colors', 'body', 'family', 'numbers', 'days', 'clothes', 'transport', 'phrases'],
}
const LEVEL_SUBTITLE = {
  ...
  '4': '🚀 Numbers, days, clothes & transport added!',
